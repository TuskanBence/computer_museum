    ...
    <div class="container">
        ...
        @if (Session::has('label_deleted'))
            <div class="alert alert-success">
                A <span style="color:white;background-color:{{ session('color') }};">{{ session('name') }}</span> label sikeresen törlésre került
            </div>
        @endif
        @if (Session::has('item_deleted'))
        <div class="alert alert-success">
            A {{session('name') }} item sikeresen törlésre került
        </div>
    @endif
        <div class="row mt-3">
